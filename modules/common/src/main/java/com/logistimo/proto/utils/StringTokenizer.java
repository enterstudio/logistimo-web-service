...
public class StringTokenizer implements java.util.Enumeration {
   ...
   * @param delimsAreTokens flag indicating whether the second parameter specifies token or
   ...
   * @param delimsAreTokens flag indicating whether the first parameter specifies token or
