...
<link rel="stylesheet" href="../autocomplete/TextboxList.Autocomplete.css" type="text/css" media="screen"
      charset="utf-8"/>
...
<script type="text/javascript">
    ...
    function initDropDowns() {
        // Init. domain selector
        var domainid = new $.TextboxList('#domainid', {
            unique: true,
            max: 1,
            plugins: {
                autocomplete: {
                    ...
                    minLength: 1,
                    queryRemote: true,
                    remote: {url: '/s/list.jsp?type=domains'}
                }
            }
        });
        // Event to toggle filter on adding a bitbox
        domainid.addEvent('bitBoxAdd', function (b) {
            document.getElementById('loader').style.display = 'block';
            window.location.href = "/s/createentity?action=switch&type=domain&view=domains&userid=" + '<%= userId %>' + "&domainid=" + b.value[0];
        });
    }
    <% } %>
...
<fmt:bundle basename="Messages">
    <div id="doc3">
        ...
        <div style="margin-top:15px">
            <!-- Dashboard -->
            <div style="float:left;width:75%;font-size:9pt">
                <!-- Events -->
                <!--
                ...
                <!-- Overview -->
                <div id="activitypanel" class="ui-widget ui-widget-content ui-corner-all"
                     style="padding:4px;margin-top:10px;margin-bottom:15px;box-shadow: 0 1px 4px rgba(0,0,0,0.5);-moz-box-shadow: 0 4px 8px rgba(0,0,0,0.5);-webkit-box-shadow: 0 4px 8px rgba(0,0,0,0.5);">
                </div>
                <!-- <div style="margin-top:20px;">
                    <img src="../images/front-pic.jpg" width="100%" height="50px;"/>
                </div>-->
                <div id="monthlychartviewpanel" style="margin-top:20px;">
                    <!-- Display the charts here. -->
                </div>
                <div style="margin-top:20px;">
        ...
        <!-- Side bars -->
        <div style="float:right;width:190px;font-size:9pt">
            <font style="font-size:11pt;font-weight:bold">Shortcuts</font>
            <!-- class="ui-widget-content ui-corner-all"  -->
            <div id="shortcuts" style="margin-bottom:10px;background-color:white;">
                <ul>
                    <% if (dc.isBBoardEnabled()) { %>
                    <li style="padding:4px;"><img src="../images/icon/bulletin_board.png" align="top"/> <a
                            href="/pub/board?domainid=<%= domainId %>" target="_new">Bulletin Board</a>
                        <% if (allowPost) { %>
                        (<a onclick="resetMessageForm(); $('#bboardpanel').dialog('open'); return false;">post</a>)
                        <% } %>
                    </li>
                    <% } %>
                    <li style="padding:4px;"><img src="../images/map16.png" align="top"/> <a
                            href="orders/orders.jsp?maps=true&subview=demandboard" target="_new">Demand map</a></li>
                    <li style="padding:4px;"><img src="../images/map16.png" align="top"/> <a
                            href="inventory/inventory.jsp?maps=true" target="_new">Inventory map</a></li>
                    <li style="padding:4px;"><img src="../images/icon/list16.png" align="top"/> <a
                            href="inventory/inventory.jsp?subview=Inventory Transactions" target="_new"><fmt:message
                            key="inventory"/> <fmt:message key="transactions"/></a></li>
                </ul>
            </div>
            ...
            <div id="downloads" style="margin-bottom:10px">
                <ul>
                    <li style="padding:4px;"><img src="../images/icon/featurephone.png" align="top"/> <a
                            href="http://m.logistimo.net/en/logistimo.jad">Feature phone (Java)</a></li>
                    <li style="padding:4px;"><img src="../images/icon/smartphone.png" align="top"/> <a
                            href="https://play.google.com/store/apps/details?id=com.logistimo.android#?t=W251bGwsMSwxLDIxMiwiY29tLmxvZ2lzdGltby5hbmRyb2lkIl0."
                            target="_new">Smart phone (Android)</a></li>
                    <li style="padding:4px;"><img src="../images/icon/html5.png" align="top"/> <a href="/m/index.html"
                                                                                                  target="_new">HTML5
                        Browser</a></li>
                </ul>
            </div>
            ...
            <div id="userguide">
                <ul>
                    <li style="padding:4px;"><img src="../images/question.png" align="top"/> <a
                            href="http://www.samaanguru.org/UserManual.pdf" target="_new"><fmt:message
                            key="setup.instruction"/></a></li>
                </ul>
            </div>
            <% if (isSuperUser) { %>
