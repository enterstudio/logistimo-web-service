...
logistimoApp.constant('NOTIFICATIONS', {
    ...
    shipments : {
        ...
        "%estimatedDateOfArrival%": {"key": "estimatedDateOfArrival", "size": "20"},
        "%materials%": {"key": "variable.materials", "size": "25"},
        "%materialsWithQuantity%": {"key": "variable.materialswithquantities", "size": "15"},
        "%materialsWithFulfiled%": {"key": "variable.materialswithfulfiled", "size": "15"},
        "%materialsWithAllocated%": {"key": "variable.materialswithallocated", "size": "15"},
        "%numberOfItems%": {"key": "numberofitems", "size": "6"},
