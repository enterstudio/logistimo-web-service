...
public interface IUserDao {
   ...
   */
  QueryParams getQueryParams(Long domainId, Map<String, Object> filters,
   ...
   */
  QueryParams getQueryParams(Long domainId, Map<String, Object> filters,
                                       boolean includeChildDomainUsers, boolean excludeSuperUsers);
   ...
   */
  List<IUserAccount> getUsers(int offset, int size);
