...
public class TransactionUtil {
  ...
  public static boolean deduplicateBySaveTimePartial(String timestampSaveMillis, String userId,
    ...
    return
        deduplicateBySaveTimePartial(timestampSaveMillis, userId, kioskId, null, partialId != null)
            ||
            (partialId != null && deduplicateBySaveTimePartial(timestampSaveMillis, userId, kioskId,
