...
public class GetLocationCommand extends HystrixCommand<LocationResponseModel> {
    ...
    public GetLocationCommand(RestTemplate restClient, LocationRequestModel model, MultiValueMap headers) {
    ...
    protected LocationResponseModel run() throws Exception {
        ...
        try {
            ResponseEntity<LocationResponseModel> entity = restClient.postForEntity(url, request, LocationResponseModel.class);
