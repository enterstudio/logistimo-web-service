 ...
 * @author Mohan Raja
 */
public interface IInventoryPredictionsLog {

  Long getKey();

  void setKey(Long key);

  Long getInventoryKey();

  void setInventoryKey(Long iKey);
  ...
  void setPredictedDaysOfStock(BigDecimal pdos);
  ...
  void setOrderPeriodicity(BigDecimal op);
}
