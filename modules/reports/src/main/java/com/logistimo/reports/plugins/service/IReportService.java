...
public interface IReportService {
  List<ReportChartModel> buildReportsData(String data,
                                          ReportCompareField compareField,
                                          Map<String, String> filters)
      throws Exception;

  TableResponseModel buildReportTableData(String json, ReportViewType viewType,
                                          QueryRequestModel model)
      throws Exception;

  String getColumns(Map<String, String> filters, ReportViewType viewType);

  String getTableColumns(Map<String, String> filters, ReportViewType viewType);
}
